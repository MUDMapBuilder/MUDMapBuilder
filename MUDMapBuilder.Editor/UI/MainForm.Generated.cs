/* Generated by MyraPad at 5/17/2024 4:11:03 AM */
using Myra;
...
namespace MUDMapBuilder.Editor.UI
{
	partial class MainForm: Panel
	{
		private void BuildUI()
		{
			...
			label7.Text = "Add Debug Info";

			_checkAddDebugInfo = new CheckButton();
			_checkAddDebugInfo.Id = "_checkAddDebugInfo";
			_checkAddDebugInfo.Content = label7;

			var label8 = new Label();
			label8.Text = "Colorize Connection Issues";
			...
			_checkColorizeConnectionIssues.Content = label8;
