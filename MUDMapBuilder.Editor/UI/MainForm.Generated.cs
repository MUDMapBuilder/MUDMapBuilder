/* Generated by MyraPad at 5/9/2024 10:47:20 PM */
using Myra;
...
namespace MUDMapBuilder.Editor.UI
{
	partial class MainForm: Panel
	{
		private void BuildUI()
		{
			...
			label5.Text = "Straighten";

			_checkButtonStraighten = new CheckButton();
			_checkButtonStraighten.IsChecked = true;
			_checkButtonStraighten.Id = "_checkButtonStraighten";
			_checkButtonStraighten.Content = label5;

			var label6 = new Label();
			label6.Text = "Compact";

			_checkButtonCompact = new CheckButton();
			_checkButtonCompact.IsChecked = true;
			_checkButtonCompact.Id = "_checkButtonCompact";
			_checkButtonCompact.Content = label6;
			...
			horizontalStackPanel2.Widgets.Add(_checkButtonStraighten);
			horizontalStackPanel2.Widgets.Add(_checkButtonCompact);

			var label7 = new Label();
			label7.Text = "<<";

			_buttonStartDebugSteps = new Button();
			_buttonStartDebugSteps.Id = "_buttonStartDebugSteps";
			_buttonStartDebugSteps.Content = label7;

			_spinButtonDebugStep = new SpinButton();
			_spinButtonDebugStep.Integer = true;
			_spinButtonDebugStep.Width = 50;
			_spinButtonDebugStep.Id = "_spinButtonDebugStep";

			var label8 = new Label();
			label8.Text = ">>";

			_buttonEndSteps = new Button();
			_buttonEndSteps.Id = "_buttonEndSteps";
			_buttonEndSteps.Content = label8;

			var horizontalStackPanel3 = new HorizontalStackPanel();
			horizontalStackPanel3.Spacing = 8;
			horizontalStackPanel3.Widgets.Add(_buttonStartDebugSteps);
			horizontalStackPanel3.Widgets.Add(_spinButtonDebugStep);
			horizontalStackPanel3.Widgets.Add(_buttonEndSteps);
			...
			_buttonPush.Content = label12;

			var horizontalStackPanel4 = new HorizontalStackPanel();
			horizontalStackPanel4.Spacing = 8;
			horizontalStackPanel4.Widgets.Add(label9);
			horizontalStackPanel4.Widgets.Add(_spinPushForceX);
			horizontalStackPanel4.Widgets.Add(label10);
			horizontalStackPanel4.Widgets.Add(_spinPushForceY);
			horizontalStackPanel4.Widgets.Add(_buttonMeasure);
			horizontalStackPanel4.Widgets.Add(_buttonPush);
		...
		public CheckButton _checkButtonStraighten;
		public CheckButton _checkButtonCompact;
		public Button _buttonStartDebugSteps;
		public SpinButton _spinButtonDebugStep;
		public Button _buttonEndSteps;
