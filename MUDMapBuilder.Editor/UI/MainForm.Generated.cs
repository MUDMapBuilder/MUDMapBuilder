/* Generated by MyraPad at 6/6/2024 3:33:49 PM */
using Myra;
...
namespace MUDMapBuilder.Editor.UI
{
	partial class MainForm: Panel
	{
		private void BuildUI()
		{
			...
			label4.Text = "Keep Solitary Rooms";

			_checkKeepSolitaryRooms = new CheckButton();
			_checkKeepSolitaryRooms.IsChecked = true;
			_checkKeepSolitaryRooms.Id = "_checkKeepSolitaryRooms";
			_checkKeepSolitaryRooms.Content = label4;

			var label5 = new Label();
			label5.Text = "Keep Rooms With Single Outside Exit";

			_checkKeepRoomsWithSingleOutsideExit = new CheckButton();
			_checkKeepRoomsWithSingleOutsideExit.IsChecked = true;
			_checkKeepRoomsWithSingleOutsideExit.Id = "_checkKeepRoomsWithSingleOutsideExit";
			_checkKeepRoomsWithSingleOutsideExit.Content = label5;
			...
			horizontalStackPanel2.Widgets.Add(_checkKeepSolitaryRooms);
			horizontalStackPanel2.Widgets.Add(_checkKeepRoomsWithSingleOutsideExit);
		...
		public CheckButton _checkKeepSolitaryRooms;
		public CheckButton _checkKeepRoomsWithSingleOutsideExit;
