/* Generated by MyraPad at 5/17/2024 11:00:15 PM */
using Myra;
...
namespace MUDMapBuilder.Editor.UI
{
	partial class MainForm: Panel
	{
		private void BuildUI()
		{
			...
			_checkFixIntersected.Content = label6;

			var label7 = new Label();
			label7.Text = "Compact Map";

			_checkCompactMap = new CheckButton();
			_checkCompactMap.IsChecked = true;
			_checkCompactMap.Id = "_checkCompactMap";
			_checkCompactMap.Content = label7;

			var label8 = new Label();
			label8.Text = "Add Debug Info";

			_checkAddDebugInfo = new CheckButton();
			_checkAddDebugInfo.Id = "_checkAddDebugInfo";
			_checkAddDebugInfo.Content = label8;

			var label9 = new Label();
			label9.Text = "Colorize Connection Issues";
			...
			_checkColorizeConnectionIssues.Content = label9;
