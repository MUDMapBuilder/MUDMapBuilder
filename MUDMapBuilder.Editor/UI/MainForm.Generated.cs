/* Generated by MyraPad at 5/8/2024 11:17:06 PM */
using Myra;
...
namespace MUDMapBuilder.Editor.UI
{
	partial class MainForm: Panel
	{
		private void BuildUI()
		{
			...
			_label = new Label();
			_label.Text = "Connections With Obstacles: 10";
			_label.TextColor = ColorStorage.CreateColor(75, 217, 97, 255);
			_label.Id = "_label";
			...
			verticalStackPanel1.Widgets.Add(_label);
